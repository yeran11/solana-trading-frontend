    ...
    <div className="relative w-full h-48 bg-[#0a1419] rounded border border-[#02b36d40] p-4 overflow-hidden">
      ...
      <div className="w-full h-10 rounded bg-[#091217] border border-[#02b36d80] flex items-center px-3 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center px-3">
          <div className="h-4 w-1 bg-[#02b36d] animate-[blink_1s_step-end_infinite]"></div>
        </div>
      </div>
      ...
      <div className="absolute bottom-4 right-4">
        <div className="relative">
          <Rocket size={28} className="text-[#02b36d] transform rotate-45" />
          <div className="absolute -bottom-2 -left-1 w-4 h-4 bg-[#02b36d30] rounded-full animate-[pulse_1s_ease-in-out_infinite]"></div>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative w-full h-48 bg-[#0a1419] rounded border border-[#02b36d40] p-4 overflow-hidden">
      ...
      <div className="w-full h-16 flex items-end space-x-1 mb-4">
        {[3, 5, 4, 7, 6, 8, 9, 8, 10, 12, 10, 14, 13, 15].map((height, i) => (
          <div 
            key={i} 
            className="flex-1 bg-[#02b36d60] rounded-t"
            style={{ 
              height: `${height * 6}%`,
      ...
      <div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#02b36d] animate-[pulse_1s_ease-in-out_infinite]"></div>
    </div>
  );
};
  ...
  return (
    <div className="relative w-full h-48 bg-[#0a1419] rounded border border-[#02b36d40] p-4 overflow-hidden">
      ...
      <div className="relative w-full h-16 mb-4 bg-[#091217] rounded border border-[#02b36d20] overflow-hidden">
        ...
        <div 
          className="absolute w-2 h-2 bg-[#02b36d] rounded-full shadow-[0_0_8px_#02b36d]"
          style={{
            top: '10%', 
            right: '0%',
      ...
      <div className="absolute bottom-2 right-2">
        <DollarSign 
          size={16} 
          className="text-[#02b36d] absolute animate-[floatUp_3s_ease-out_infinite]" 
          style={{right: '0px'}}
        />
        <DollarSign 
          size={16} 
          className="text-[#02b36d] absolute animate-[floatUp_3s_ease-out_infinite_0.5s]" 
          style={{right: '10px'}}
        />
        <DollarSign 
          size={16} 
          className="text-[#02b36d] absolute animate-[floatUp_3s_ease-out_infinite_1s]" 
          style={{right: '20px'}}
        />
      </div>

      {/* Flash effect */}
      <div className="absolute inset-0 bg-[#02b36d] opacity-0 animate-[flash_5s_ease-in-out_infinite]"></div>
    </div>
  );
};
